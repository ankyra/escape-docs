...
To make sure everything is set up correctly, let's create a little workspace
and run the obligatory Hello World unit.
...
If everything is working correctly the output of the last command should
be `"Hello, World!"`. If not: please let us know.
...
With a bit of luck this should now say "Hello, You!". Magical, but how does it
work?
